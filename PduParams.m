classdef PduParams< matlab.mixin.SetGet
    ...
    properties
        ...
        q = 1e-12;           % added, amt of R5P produced by RPIA (µmol/s)         8.08e-16                 MCP: 0          human: 8.66*1e9
        ...
        NCDE = 1e6;           % number of PduCDE active sites (updated based on MFS data)   e3              MCP: 1500       human: 3.38*1e5
        ...
        NPQ = 1e6;         % number of PduP/PduQ active sites (updated based on MFS data)     e4         MCP: 2500       human: 1.76*1e6
